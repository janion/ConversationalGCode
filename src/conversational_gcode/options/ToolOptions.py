...
class ToolOptions:
    ...
    def __init__(self,
        ...
        :param feed_rate: Rate at which to feed the tool while cutting.
        Defaults to 100mm per minute.
        ...
        :param helix_feed_rate: Rate at which to feed the tool while cutting a helix.
         Defaults to None to match the normal feed rate.
        :param max_helix_angle: Maximum angle at which to plunge the tool while cutting a helix.
        ...
        :param finishing_feed_rate: Rate at which to feed the tool while cutting a finishing pass.
        Defaults to None to match the normal feed rate.
        :param finishing_climb: Whether to cut the finishing pass as a climb cut or conventional
        cut. Defaults to False to indicate a conventional cut direction.
        """
    ...
    def validate(self) -> list[ValidationResult]:
        ...
        if self._finishing_pass is not None:
            ...
            if self._finishing_pass > 0 and not isinstance(self._finishing_climb, bool):
