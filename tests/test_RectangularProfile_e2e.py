...
class TestRectangularProfile(EndToEndTester):

    def test_shallow_square_origin_centre(self):
        self.gcode_generator.add_operation(
            RectangularProfile(width=20, length=20, depth=2)
        )

        self.assertFileMatches('resources/e2e/rectangular_profile/shallow_square_origin.nc')

    def test_shallow_long_origin_centre(self):
        self.gcode_generator.add_operation(
            RectangularProfile(width=20, length=30, depth=2)
        )

        self.assertFileMatches('resources/e2e/rectangular_profile/shallow_long_origin.nc')

    def test_shallow_wide_origin_centre(self):
        self.gcode_generator.add_operation(
            RectangularProfile(width=30, length=20, depth=2)
        )

        self.assertFileMatches('resources/e2e/rectangular_profile/shallow_wide_origin.nc')
    ...
    @skip('Finishing passes not yet supported')
    ...
    #     )
    #
    #     self.assertFileMatches('resources/e2e/rectangular_profile/deep_long_position_finishing.nc', True)
    ...
    #     )
    #
    #     self.assertFileMatches('resources/e2e/rectangular_profile/deep_long_position_finishing_conventional.nc', True)

    def test_shallow_square_origin_corner(self):
        self.gcode_generator.add_operation(
            RectangularProfile(width=20, length=20, depth=2, corner=[-10, -10])
        )
    ...
    def test_shallow_long_origin_corner(self):
        self.gcode_generator.add_operation(
            RectangularProfile(width=20, length=30, depth=2, corner=[-10, -15])
        )
    ...
    def test_shallow_wide_origin_corner(self):
        self.gcode_generator.add_operation(
            RectangularProfile(width=30, length=20, depth=2, corner=[-15, -10])
        )
